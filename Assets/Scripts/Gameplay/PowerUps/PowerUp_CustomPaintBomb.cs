...
{
    public class PowerUp_CustomPaintBomb : PowerUp
    {
        ...
        public override void OnPlayerTouched (Player _Player)
        {
            ...
            m_TerrainService.FillCircle(_Player, m_GameService.GetRandomPosition(), m_Radius * m_RadiusMultiplier, m_FillDuration, SelfDestroy);
        }
